...
- [x] The pop-up slides down into position when you click the open button and slides back up when you click 'close modal'
- [x] The opacity fades smoothly in and out when toggling the modal